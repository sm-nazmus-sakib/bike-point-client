        ...
        <div className="row user">
            <div className="d-flex flex-column flex-shrink-0 bg-light vh-700 col-md-1 col-3 pt-5 ps-2 mx-auto">
                <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
                    <li className="nav-link active py-3 border-bottom nav-item" onClick={() => setActive('My Orders')}> <i class="fas fa-cart-plus"></i> <small>My Orders</small></li>
                    ...
                    <li className="nav-link py-3 border-bottom" onClick={() => setActive('Pay')}><i class="fab fa-cc-amazon-pay"></i> <small>Pay</small> </li>
